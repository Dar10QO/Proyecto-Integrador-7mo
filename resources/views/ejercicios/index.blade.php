...
<head>
    ...
    <style>
        ...
        .card-body {
            padding: 20px;
            min-height: 150px; /* Altura mínima para la descripción */
        }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('ejercicios.index') }}">Biblioteca de Ejercicios</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-4">
        <h1 class="text-center mb-4">Biblioteca de Ejercicios</h1>

        <div class="filter-container">
            <form action="{{ route('ejercicios.index') }}" method="GET" class="row g-3">
                <div class="col-md-10">
            ...
            @forelse($ejercicios as $ejercicio)
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <span class="badge rounded-pill mb-2">{{ $ejercicio->grupoMuscular->nombre }}</span>
