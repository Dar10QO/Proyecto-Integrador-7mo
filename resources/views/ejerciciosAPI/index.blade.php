...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="api-badge">Datos desde API</div>

        <div class="filter-container">
            <form action="{{ route('api.ejercicios.index') }}" method="GET" class="row g-3">
                <div class="col-md-10">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-descripcion">
                                {{ \Illuminate\Support\Str::limit($ejercicio['descripcion'], 100) }}
                            </div>
                            <div class="mt-3">
                                <a href="{{ route('api.ejercicios.show', $ejercicio['id']) }}" class="btn btn-sm btn-primary">
                                    Ver detalles
                                </a>
                            </div>
                        </div>
