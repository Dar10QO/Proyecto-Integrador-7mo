<x-app-layout>
                ...
                <div class="p-6 text-gray-900">
                    <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                        ...
                        <div id="profile"
                            ...
                            <div class="p-4 md:p-12 text-center lg:text-left">
                                ...
                                <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center">
                                    <img src="{{asset('img/nutriologo.jpeg')}}" class="rounded-full" alt="">
                                </div>

                                <h1 class="text-3xl font-bold pt-8 lg:pt-0">Arturo</h1>
                                ...
                                <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                                    ...
                                    </svg>Queretaro, Santiago de Queretaro
                                </p>
                                <p class="pt-8 text-sm">Soy nutriologo/a con experiencia en la evaluación de necesidades dietéticas y el diseño de planes de alimentación personalizados. Me especializo en promover hábitos alimenticios saludables y en educar a mis pacientes sobre la importancia de una dieta equilibrada. Mi enfoque integral me permite ayudar a gestionar condiciones de salud relacionadas con la alimentación, como la obesidad y la diabetes, contribuyendo así al bienestar general de mis pacientes. Estoy comprometido/a con el acompañamiento y la motivación para alcanzar sus objetivos de salud.</p>
                        ...
                        <div class="w-full lg:w-2/5">
                            ...
                            <img src="{{asset('img/nutriologo.jpeg')}}" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
    ...
    <form class="w-full mx-auto" action="{{ route('perfil.contact') }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="nombre" name="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 -700 dark:border-gray-600 dark:placeholder-gray-400 -white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
        </div>
        <div class="mb-5">
            <label for="telefono" class="block mb-2 text-sm font-medium text-gray-900 -white">Telefono</label>
            <input type="text" id="telefono" name="telefono" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 -700 dark:border-gray-600 dark:placeholder-gray-400 -white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
        </div>
        <div class="mb-5">
            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 -white">Email</label>
            <input type="email" id="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 -700 dark:border-gray-600 dark:placeholder-gray-400 -white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
        </div>
